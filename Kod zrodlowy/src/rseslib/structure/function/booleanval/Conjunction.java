...
/**
 * Conjunction of boolean functions on double data.
 *
 * @author      Arkadiusz Wojna
 */
public class Conjunction implements BooleanFunction
{
    /** Components of this conjunction. */
    BooleanFunction[] m_arrComponents;

    /**
     * Constructor.
     *
     * @param components Components of this conjunction.
     */
    public Conjunction(BooleanFunction[] components)
    {
    ...
    {
        boolean value = true;
        for (int i = 0; i < m_arrComponents.length && value; i++)
        	value = m_arrComponents[i].booleanVal(dObj);
        return value;
    }
