...
/**
 * Class realizing expotential kernel function
 */
public class ExpotentialKernelFunction  implements KernelFunction {
    ...
    /**
     *    Expotential function = e^((-||x-y||)/(2*sigma^2))
     * @param tab
     * @param s  sigma
     */
    public ExpotentialKernelFunction(DoubleDataTable tab, double s) {
    ...
    public double K(DoubleData dObj1, DoubleData dObj2) {
        ...
        result = Math.exp(-Math.sqrt(result)/(2*sigma*sigma));
        return result;
    }
