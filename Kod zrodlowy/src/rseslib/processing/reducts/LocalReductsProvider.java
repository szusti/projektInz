 ...
 *
 */
public class LocalReductsProvider extends Configuration implements ReductsProvider
{
     ...
     * 
     */
    public LocalReductsProvider(Properties prop, DoubleDataTable table) throws PropertyConfigurationException
    {
        super(prop);
    ...
    public Collection<BitSet> getReducts()
    {
    	...
    	for (DoubleData obj : m_Objects)
    		reducts.addAll(getSingleObjectReducts(obj));
    	return reducts;
    }
