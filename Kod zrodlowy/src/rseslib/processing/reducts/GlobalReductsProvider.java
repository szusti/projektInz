 ...
 *
 */
public class GlobalReductsProvider extends Configuration implements ReductsProvider
{
     ...
     * 
     */
    public GlobalReductsProvider(Properties prop, DoubleDataTable table) throws PropertyConfigurationException
    {
        super(prop);
