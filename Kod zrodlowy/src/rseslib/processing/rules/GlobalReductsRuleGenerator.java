 ...
 *
 */
public class GlobalReductsRuleGenerator extends Configuration implements RuleGenerator
{
     ...
     * 
     */
    public GlobalReductsRuleGenerator(Properties prop) throws PropertyConfigurationException
    {
        super(prop);
    ...
    {
		prog.set("Generating global reducts and rules", tab.getDataObjects().size());
    	GlobalReductsProvider reductsProv = new GlobalReductsProvider(getProperties(), tab);
